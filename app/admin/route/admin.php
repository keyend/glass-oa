...
Route::group(function() {
    ...
    Route::group('order', function() {
        ...
        Route::post('delete', '/delete')->name('orderDelete');
        Route::rule("delivery/list", '/deliveryList', 'POST|GET')->name('delivery');
        Route::rule('delivery/print', '/deliveryPrint', 'POST|GET')->name('orderDeliveryManger');
        ...
        Route::rule('label', '/label')->name("orderLabelManager");
        Route::post('print/delivery/record', '/printDeliveryRecord')->name('orderDeliveryPrint');
        Route::post('print/record', '/printRecord')->name('orderLabelPrint');
        Route::get('print', '/print')->name('orderPrint');
        Route::rule('supplement', '/supplement', 'GET|POST')->name('supplement');
