<?php /*a:2:{s:82:"D:\xampp\cygwin\www\wwwroot\cloud\or.xmr.la\app\admin\view\system\group\index.html";i:1686882112;s:68:"D:\xampp\cygwin\www\wwwroot\cloud\or.xmr.la\app\admin\view\base.html";i:1688009496;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div class="layui-form layui-card-header layuiadmin-card-header-auto layui-form-filter">
                                    <div class="layui-form-item">
                                        <div class="layui-inline btn-group">
                                            <button class="layui-btn layui-btn-sm layui-btn-normal layuiadmin-btn-admin" data-type="add"><i class="layui-icon">&#xe654;</i> 添加组</button>
                                        </div>
...
<script>
    layui.config({
        ...
        var active = {
            add: function(){
                ns.open("<?php echo url('sysGroupAdd'); ?>", '添加用户组').then(() => {
                    renderTable()
                })
            }
        };
