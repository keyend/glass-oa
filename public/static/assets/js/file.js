...
function upload(){
    ...
    let w = window.screen.width < 768 ? '95%' : '520px';

    let h = window.screen.width < 768 ? '95%' : '413px';
...
function moveFiles(ids="",idFs=""){
    ...
    let w = window.screen.width < 768 ? '95%' : '510px';

    let h = window.screen.width < 768 ? '95%' : '355px';
            ...
            success: function (data2) {
...

                {
                    ...
                    for(var i=0;i<data.length;i++){
                        $("text[data-id='"+data[i]+"']").parent().parent().parent().remove();
                    }
...

{
    ...
    let w = window.screen.width < 768 ? '95%' : '325px';

    let h = window.screen.width < 768 ? '95%' : '270px';
...
$(".context-menu .list li").click(function(){
    ...
    if(Url2=="undefined"){
        layer.msg('复制失败', {time:1000, icon:1, shift:4});break;
    }else{
        ...
        case "编辑文件":{
            ...
            let w = window.screen.width < 768 ? '95%' : '342px';

            let h = window.screen.width < 768 ? '95%' : '350px';
                ...
                $.ajax({
                    ...
                    success: function (data) {
...

                        {
                            ...
                            $("text[data-id='"+id+"']").parent().parent().parent().remove();
